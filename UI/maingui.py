...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_3.setGeometry(QtCore.QRect(100, 75, 47, 13))
        self.label_3.setObjectName("label_3")
        self.forced_cbox = QtWidgets.QComboBox(Form)
        self.forced_cbox.setGeometry(QtCore.QRect(143, 70, 45, 22))
        self.forced_cbox.setObjectName("forced_cbox")
        self.forced_cbox.addItem("")
        self.forced_cbox.addItem("")
        self.label_4 = QtWidgets.QLabel(Form)
        self.label_4.setGeometry(QtCore.QRect(190, 75, 31, 13))
        self.label_4.setObjectName("label_4")
        self.language_cbox = QtWidgets.QComboBox(Form)
        self.language_cbox.setGeometry(QtCore.QRect(222, 70, 45, 22))
        self.language_cbox.setObjectName("language_cbox")
        self.language_cbox.addItem("")
        self.language_cbox.addItem("")
        self.label_5 = QtWidgets.QLabel(Form)
        self.label_5.setGeometry(QtCore.QRect(268, 75, 75, 13))
        self.label_5.setObjectName("label_5")
        self.delay_LE = QtWidgets.QLineEdit(Form)
        self.delay_LE.setGeometry(QtCore.QRect(345, 70, 50, 22))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_6.setGeometry(QtCore.QRect(397, 75, 80, 13))
        self.label_6.setObjectName("label_6")
        self.name_LE = QtWidgets.QLineEdit(Form)
        self.name_LE.setGeometry(QtCore.QRect(479, 70, 161, 22))
